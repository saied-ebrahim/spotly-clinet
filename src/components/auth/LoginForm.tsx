...
export default function LoginForm() {
  return (
    <form className="flex flex-col gap-4 w-full">
      ...
      <button
        type="submit"
        className="bg-[#2B293D] w-full py-3 text-white text-base font-bold rounded-lg transition-all duration-200 hover:bg-[#4A4763] hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-[#2B293D]/50"
      >
        Sign In
      </button>
