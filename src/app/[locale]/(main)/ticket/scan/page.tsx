  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden relative min-h-[400px] flex flex-col">
        ...
        {error && (
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
            ...
            <button onClick={handleReset} className="px-6 py-2 bg-blue-600 text-white rounded-lg font-medium">
              Try Again
            </button>
          </div>
        )}
        ...
        {!error && isScanning && (
          <div className="relative flex-1 bg-black flex flex-col items-center justify-center">
            ...
            <div className="relative z-10 w-64 h-64 border-4 border-white/50 rounded-lg flex items-center justify-center">
              ...
              <p className="mt-80 text-white font-medium drop-shadow-md">Point at QR Code</p>
            </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 animate-in fade-in zoom-in duration-300">
            ...
            {validationStatus === 'validating' && (
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs text-gray-400 mt-2 font-mono break-all max-w-[200px] text-center">{scanResult}</p>
              </div>
            )}
            ...
            {validationStatus === 'valid' && (
              <div className="flex flex-col items-center text-center">
                ...
                <div className="bg-gray-100 p-4 rounded-lg w-full mb-6">
                  ...
                  <p className="font-mono text-gray-700 break-all">{scanResult}</p>
                </div>
            ...
            {validationStatus === 'invalid' && (
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-500 mb-6">This ticket code is not recognized or has already been used.</p>
                
                <div className="bg-red-50 p-4 rounded-lg w-full mb-6 border border-red-100">
                  <p className="text-xs text-red-400 uppercase font-bold tracking-wider mb-1">Scanned Code</p>
                  <p className="font-mono text-red-700 break-all">{scanResult}</p>
                </div>
      ...
      <p className="mt-8 text-xs text-gray-400 text-center max-w-xs">
        Ensure you are in a well-lit area. <br/> Works best with high contrast QR codes.
      </p>
