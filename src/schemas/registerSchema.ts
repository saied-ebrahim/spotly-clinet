...
export const adminStep1Schema = (t: ReturnType<typeof useTranslations<"">>) =>
  yup.object().shape({
    firstName: yup
      .string()
      .required(t("auth.firstNameRequired"))
...
export const adminStep2Schema = (t: ReturnType<typeof useTranslations<"">>) =>
  yup.object().shape({
    adminCode: yup
      .string()
      .required(t("auth.adminCodeRequired"))
      .matches(/^[A-Z0-9]{8,12}$/, t("auth.adminCodeInvalid")),
    department: yup
      .object()
      .shape({
        label: yup.string().required(t("auth.departmentRequired")),
        value: yup.string().required(t("auth.departmentRequired")),
      })
      .required(t("auth.departmentRequired"))
      .typeError(t("auth.departmentInvalid")),
    adminRole: yup
      .object()
      .shape({
        label: yup.string().required(t("auth.adminRoleRequired")),
        value: yup.string().required(t("auth.adminRoleRequired")),
      })
      .required(t("auth.adminRoleRequired"))
      .typeError(t("auth.adminRoleInvalid")),
  });
